...
import { Calendar, Clock, User, Plus, Search, Edit, Trash2, ExternalLink } from 'lucide-react';
import { useToast } from '@/hooks/use-toast';

const AdminSessions = () => {
  const { sessions, addSession, updateSession, deleteSession } = useSessionManager();
  ...
  const handleUpdateSession = (sessionData: Omit<ClassSession, 'id'>) => {
    if (editingSession) {
