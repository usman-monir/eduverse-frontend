  ...
  const handleSubmitRequest = async () => {
    if (
      ...
      toast({
        ...
        description:
          'All fields except message are required to submit a request.',
        variant: 'destructive',
      });
      return;
    }
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your request has been sent to the admin for approval. You'll receive an email confirmation once approved.",
      });
      // Reset form
      ...
      toast({
        ...
        description:
          err.response?.data?.message || 'Could not submit slot request.',
        variant: 'destructive',
      });
    } finally {
      setLoading(false);
      ...
      <div className='space-y-6'>
        ...
        <div>
          ...
          <p className='text-gray-600'>
            Submit a request for your preferred class schedule
          </p>
        </div>
          ...
          <div className='space-y-6'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Any specific requirements or notes for your session
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Textarea
        ...
        <Card className='bg-yellow-50 border-yellow-200'>
          ...
          <CardContent className='text-yellow-700'>
            <ul className='space-y-2 text-sm'>
              <li>
                • Requests will be reviewed by our admin team within 24 hours
              </li>
              <li>
                • You'll receive an email notification once your request is
                approved or needs modification
              </li>
              <li>
                • Approved sessions will automatically appear in your dashboard
                with meeting links
              </li>
              <li>• Please submit requests at least 48 hours in advance</li>
              <li>
                • You can track the status of your requests in your dashboard
              </li>
            </ul>
          </CardContent>
        </Card>
